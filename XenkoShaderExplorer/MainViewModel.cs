...
namespace XenkoShaderExplorer
{
  public class MainViewModel : ViewModelBase
  {
    ...
    /// </summary>
    public IEnumerable<Shader> AllShaders
    {
      get => ShadersInPostOrder();
    }
    ...
    public MainViewModel()
    {
      try
      {
        ...
        var xenkoDir = System.IO.Path.Combine(userDir, ".nuget", "packages", ConfigurationManager.AppSettings["XenkoShaderPackageNugetDirectory"]);
